contract InferredHelpers where
  ...
  entry decrement (n : Word) : Eff Sig Word :=
    do c <- sload count ;
       ...
       let d : Word := subLe c n ordered(n, c) ;
