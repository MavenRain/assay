...
ENTRIES = {
    ...
    'layout_mapping': 'Tests.adapter(Mapping_layout.main(args))',
...
RUNTEST = (
    ...
    ('layout_mapping', ('slot|uint256|0|0',), 'OK 78338746147236970124700731725183845421594913511827187288591969170390706184117'),
