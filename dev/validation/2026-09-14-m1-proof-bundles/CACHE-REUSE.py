"""Reuse checked proof dependencies and unchanged Lean build artifacts."""
...
source = Path('/Users/oobi/Documents/gpt1/assay-m1-proof-helpers')
target = Path('/Users/oobi/Documents/gpt1/assay-m1-proof-bundles')
